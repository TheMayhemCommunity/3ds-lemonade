...
void GMainWindow::UpdateWindowTitle() {
    ...
    if (game_title.isEmpty()) {
        setWindowTitle(QStringLiteral("Citri %1").arg(full_name));
    } else {
        setWindowTitle(QStringLiteral("Citri %1 | %2").arg(full_name, game_title));
        render_window->setWindowTitle(
            QStringLiteral("Citra %1 | %2 | %3").arg(full_name, game_title, tr("Primary Window")));
        secondary_window->setWindowTitle(QStringLiteral("Citri %1 | %2 | %3")
